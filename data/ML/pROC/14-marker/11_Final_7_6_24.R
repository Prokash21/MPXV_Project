...
X <- read.csv("11_pROC.csv" , header = TRUE,row.names = 1)
...
gene_list <- c("WDR37", "NFAT5", "ICAM5", "ELL", "PLAGL1", "DHX38",
               "GATA6", "ZNF212", "CBX6", "ATP5MG", "GM2A")
...
# Select the 14 genes
genes <- X[, c("WDR37", "NFAT5", "ICAM5", "ELL", "PLAGL1", "DHX38",
               "GATA6", "ZNF212", "CBX6", "ATP5MG", "GM2A")]
